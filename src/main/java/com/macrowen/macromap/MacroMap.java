...
public class MacroMap extends ScrollView {
  ...
  public interface OnMapLoadStatusChangeListener {
    public void onMapLoadStatusChange(MapLoadStatus status);
  }
  ...
  private OnMapLoadStatusChangeListener mOnMapLoadStatusChangeListener;
  ...
  public void setOnMapLoadStatusChangeListener(OnMapLoadStatusChangeListener listener) {
    this.mOnMapLoadStatusChangeListener = listener;
  }
  ...
  int setJson(String mallid, String floorid, File file) {
    try {
      ...
      if (mall == mMall) {
        mRedraw = true;
        addScale(1);
        mOnMapLoadStatusChangeListener.onMapLoadStatusChange(MapLoadStatus.MAPLOADED);
        // addOffset(0, 0);
        // invalidate();
        logd("file.length()=" + file.length());
      }
